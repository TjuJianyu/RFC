...
from dataset.camelyon17_dataset import SynCamelyon17Dataset,SynThrCamelyon17Dataset
...
def main():
    ...
    parser.add_argument('--syn_threshold', type=float, default=0,
                            help='used for synthesis phase. Pseudolabel is generated by multinoimal or argmax')
    parser.add_argument('--group_method', type=str, default='balance')
    ...
    if config.dataset == 'camelyon17':
        ...
        #     groups[:,i] = 1 - groups[:,i]
        # print(groups)
        # print(groups[:,:2].prod(axis=1).mean())
        # print(groups.prod(axis=1))
        # print(groups.prod(axis=1).mean())
