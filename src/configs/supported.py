...
algo_log_metrics = {
    ...
    None: None,
    'rfcmtaccuracy':RFCmtAccuracy(prediction_fn=multiclass_logits_to_pred)
...
algorithms = ['mtERM','ERM','CLOvE','VREX', 'groupDRO', 'deepCORAL', 'IRM', 'DANN', 'AFN', 'FixMatch', 'PseudoLabel', 'NoisyStudent']
...
# See losses.py
losses = ['rfcmt_cross_entropy','cross_entropy', 'lm_cross_entropy', 'MSE', 'multitask_bce', 'fasterrcnn_criterion', 'cross_entropy_logits']
