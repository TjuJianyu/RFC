#!/bin/bash
#SBATCH --job-name=camelyon17_rfc_r0r1_syneven_irm
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
do 
	for seed in 0 1 2 3 4;
		do
		for lambda in 0 0.5 1 5 10 50 100 500 1000 0.25 0.75 2.5 7.5 25 75 250 750; 
...
resdir=results/irml2${final_synwd}_camelyon17_${mark}_lambda${final_lambda}_seed${final_seed} 
