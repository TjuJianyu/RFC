#!/bin/bash
#SBATCH --job-name=camelyon17_rfc_r0r1r2_syneven_clovelinear
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
resdir=results/clovelinear_ks0.1_camelyon17_${mark}_lambda${final_lambda}_seed${final_seed} 
...
--freeze_featurizer True --kernel_scale 0.1 
