...
python src/analysis_earlystop.py --result_dir results/erm_camelyon17_seed${final_seed}/
...
python src/run_expt_rfc.py --version "1.0" --root_dir data/camelyon17/ --save_step 1 \
