#!/bin/bash
#SBATCH --job-name=camelyon17_rfc_r0r1_syneven_clove
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
do 
	for seed in 0 1 2 3 4;
		do
		for lambda in 0.00075 0.0025 0.0075 0.025 0.075 0.25 0.75; 
			do 
				seeds[$i]=$seed;
				lambdas[$i]=$lambda;
				syn_wds[$i]=$syn_wd;
...
resdir=results/clovel2${final_synwd}_ks0.1_camelyon17_${mark}_lambda${final_lambda}_seed${final_seed} 
...
--freeze_featurizer False --kernel_scale 0.1 
